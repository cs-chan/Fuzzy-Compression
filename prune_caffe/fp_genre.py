...
model_folder = './models/alexnet_finetune_genre'
prototxt = model_folder + '/train_val.prototxt'
caffemodel = model_folder + '/caffe_alexnet_genre_train.caffemodel'
layers = ['conv1', 'conv2', 'conv3', 'conv4', 'conv5', 'fc6', 'fc7', 'fc8_genre']
suffix = 'fp'
